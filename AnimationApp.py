...
class AnimationApp():
    ...
    def animation_loop(self, i, axs, controller): 
        ...
        if (self.doAnimation_flag == True):
            ...
            controller.frames["MainPageGUI"].label_tc0.config(text = "tc0: " + '{:10.2f} C'.format(new_tc0_value))
            controller.frames["MainPageGUI"].label_tc1.config(text = "tc1: " + '{:10.2f} C'.format(new_tc1_value))
            controller.frames["MainPageGUI"].label_tc2.config(text = "tc2: " + '{:10.2f} C'.format(new_tc2_value))
            controller.frames["MainPageGUI"].label_tc3.config(text = "tc3: " + '{:10.2f} C'.format(new_tc3_value))
